...
abstract class People implements ActiveRecordInterface
{
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[PeopleTableMap::COL_TITLE] = true;
        }
    ...
    public function setLastname($v)
    {
        ...
        if ($this->lastname !== $v) {
            $this->lastname = $v;
            $this->modifiedColumns[PeopleTableMap::COL_LASTNAME] = true;
        }
    ...
    public function setFirstname($v)
    {
        ...
        if ($this->firstname !== $v) {
            $this->firstname = $v;
            $this->modifiedColumns[PeopleTableMap::COL_FIRSTNAME] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[PeopleTableMap::COL_EMAIL] = true;
        }
    ...
    public function setAddress($v)
    {
        ...
        if ($this->address !== $v) {
            $this->address = $v;
            $this->modifiedColumns[PeopleTableMap::COL_ADDRESS] = true;
        }
    ...
    public function setState($v)
    {
        ...
        if ($this->state !== $v) {
            $this->state = $v;
            $this->modifiedColumns[PeopleTableMap::COL_STATE] = true;
        }
    ...
    public function setLatitude($v)
    {
        ...
        if ($this->latitude !== $v) {
            $this->latitude = $v;
            $this->modifiedColumns[PeopleTableMap::COL_LATITUDE] = true;
        }
    ...
    public function setLongitude($v)
    {
        ...
        if ($this->longitude !== $v) {
            $this->longitude = $v;
            $this->modifiedColumns[PeopleTableMap::COL_LONGITUDE] = true;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[PeopleTableMap::COL_PHONE] = true;
        }
    ...
    public function setLang($v)
    {
        ...
        if ($this->lang !== $v) {
            $this->lang = $v;
            $this->modifiedColumns[PeopleTableMap::COL_LANG] = true;
        }
    ...
    /**
     * Sets the value of the [mailinglist] column.
    ...
    public function setMailinglist($v)
    {
        ...
        if ($this->mailinglist !== $v) {
            $this->mailinglist = $v;
            $this->modifiedColumns[PeopleTableMap::COL_MAILINGLIST] = true;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PeopleTableMap::COL_STATE)) {
            $modifiedColumns[':p' . $index++]  = 'state';
        }
        if ($this->isColumnModified(PeopleTableMap::COL_LATITUDE)) {
            $modifiedColumns[':p' . $index++]  = 'latitude';
        }
        if ($this->isColumnModified(PeopleTableMap::COL_LONGITUDE)) {
            $modifiedColumns[':p' . $index++]  = 'longitude';
        }
        if ($this->isColumnModified(PeopleTableMap::COL_PHONE)) {
            $modifiedColumns[':p' . $index++]  = 'phone';
        }
        if ($this->isColumnModified(PeopleTableMap::COL_LANG)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PeopleTableMap::COL_LASTNAME)) {
            $criteria->add(PeopleTableMap::COL_LASTNAME, $this->lastname);
        }
        if ($this->isColumnModified(PeopleTableMap::COL_FIRSTNAME)) {
            $criteria->add(PeopleTableMap::COL_FIRSTNAME, $this->firstname);
        }
        if ($this->isColumnModified(PeopleTableMap::COL_EMAIL)) {
        ...
        if ($this->isColumnModified(PeopleTableMap::COL_STATE)) {
            $criteria->add(PeopleTableMap::COL_STATE, $this->state);
        }
        if ($this->isColumnModified(PeopleTableMap::COL_LATITUDE)) {
            $criteria->add(PeopleTableMap::COL_LATITUDE, $this->latitude);
        }
        if ($this->isColumnModified(PeopleTableMap::COL_LONGITUDE)) {
            $criteria->add(PeopleTableMap::COL_LONGITUDE, $this->longitude);
        }
        if ($this->isColumnModified(PeopleTableMap::COL_PHONE)) {
            $criteria->add(PeopleTableMap::COL_PHONE, $this->phone);
        }
        if ($this->isColumnModified(PeopleTableMap::COL_LANG)) {
            $criteria->add(PeopleTableMap::COL_LANG, $this->lang);
        }
        if ($this->isColumnModified(PeopleTableMap::COL_MAILINGLIST)) {
            $criteria->add(PeopleTableMap::COL_MAILINGLIST, $this->mailinglist);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setMailinglist($this->getMailinglist());
