...
abstract class User implements ActiveRecordInterface
{
    ...
    /**
     * The value for the lastpage field.
     * @var        string
     */
    protected $lastpage;
    ...
    public function getLastlogin($format = NULL)
    {
        if ($format === null) {
            ...
            return $this->lastlogin instanceof \DateTime ? $this->lastlogin->format($format) : null;
        }
    }
    ...
    public function getLastaccess($format = NULL)
    {
        if ($format === null) {
            ...
            return $this->lastaccess instanceof \DateTime ? $this->lastaccess->format($format) : null;
        }
    }

    /**
     * Get the [lastpage] column value.
     *
     * @return string
     */
    ...
    {
        if ($this->aPeople !== null && $this->id !== $this->aPeople->getId()) {
            $this->aPeople = null;
        }
    } // ensureConsistency
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setLastlogin($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setLastaccess($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setLastpage($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setLastip($arr[$keys[5]]);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setLastpage($this->getLastpage());
     ...
     * @return ChildPeople The associated ChildPeople object.
     * @throws PropelException
     */
    ...
    if (is_callable(array('\People', $name))) {
        if (!$delegate = $this->getPeople()) {
            $delegate = new ChildPeople();
            $this->setPeople($delegate);
        }
